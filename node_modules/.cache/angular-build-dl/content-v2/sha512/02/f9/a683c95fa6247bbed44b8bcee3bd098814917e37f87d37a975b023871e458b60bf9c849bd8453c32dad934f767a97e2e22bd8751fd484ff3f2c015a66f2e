...
(window["webpackJsonp"] = window["webpackJsonp"] || []).push([["tab1-tab1-module"], {
  ...
  function srcAppTab1Tab1PageTs(module, __webpack_exports__, __webpack_require__) {
    ...
    var Tab1Page = /*#__PURE__*/function () {
      function Tab1Page(gestureCtrl, plt, modalController, router) {
      ...
      _createClass(Tab1Page, [{
        key: "ngOnInit",
        value: function ngOnInit() {//  this.checkPhoto();
        ...
        value: function onLike() {
          var card = this.cards.toArray()[this.cards.toArray().length - this.nbr];
          card.nativeElement.style.transition = '1s ease-out';
          card.nativeElement.style.transform = "translateX(".concat(+this.plt.width() * 2, "px)\n              rotate(", 100, "deg)");
          this.nbr++;
        } // DISLIKE ACTION
        ...
        key: "useTinderSwipe",
        value: function useTinderSwipe(cardArray) {
          var _this = this;
          ...
          var _loop = function _loop(i) {
            ...
            var gesture = _this.gestureCtrl.create({
              ...
              onMove: function onMove(ev) {
                card.nativeElement.style.transform = "translateX(".concat(ev.deltaX, "px)\n          rotate(").concat(ev.deltaX / 10, "deg)");

                _this.setCardColor(ev.deltaX, card.nativeElement);
              },
              onEnd: function onEnd(ev) {
                card.nativeElement.style.transition = '1s ease-out';

                if (ev.deltaX > 150) {
                  card.nativeElement.style.transform = "translateX(".concat(+_this.plt.width() * 2, "px)\n            rotate(").concat(ev.deltaX / 2, "deg)");
                  _this.nbr++;
    ...
    Object(tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"])([Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["ViewChildren"])(_ionic_angular__WEBPACK_IMPORTED_MODULE_2__["IonCard"], {
